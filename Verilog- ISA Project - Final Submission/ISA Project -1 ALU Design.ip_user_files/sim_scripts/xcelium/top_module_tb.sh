...
compile()
{
  ...
  "../../../ISA Project -1 ALU Design.srcs/sim_1/new/top_module_tb.v" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.top_module_tb xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.top_module_tb -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log top_module_tb_sc.so .tmp_log xcelium_lib waves.shm c.obj)
