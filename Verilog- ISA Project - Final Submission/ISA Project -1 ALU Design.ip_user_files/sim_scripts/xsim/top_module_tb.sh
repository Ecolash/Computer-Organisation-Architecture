...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot top_module_tb xil_defaultlib.top_module_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_module_tb -key {Behavioral:sim_1:Functional:top_module_tb} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/digantam/.var/app/com.github.corna.Vivado/data/xilinx-install/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_module_tb.wdb xsim.dir libdpi.so)
