...
#
# Script generated by Vivado on Tue Nov 12 14:56:57 IST 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : test_processor_tb.sh
...
#
# Usage        : test_processor_tb.sh
#                test_processor_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                test_processor_tb.sh [-reset_run]
#                test_processor_tb.sh [-reset_log]
#                test_processor_tb.sh [-help]
#
...
#                script (type 'test_processor_tb.sh -help' for more information).
#
...
# script info
echo -e "test_processor_tb.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./test_processor_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/ALU32.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/Data_Memory.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/Instruction_Memory.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/Lib_Arithmetic.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/Lib_Comp.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/Lib_Logical.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/Lib_Mux.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/Lib_Shift.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/REG_BANK.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/branch_control.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/control_unit.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/datapath.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/lib_datapath.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sources_1/new/processor_top.v" \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sim_1/new/test_processor_tb.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.test_processor_tb xil_defaultlib.glbl -o test_processor_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./test_processor_tb_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key test_processor_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc test_processor_tb_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./test_processor_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: test_processor_tb.sh [-help]\n\
Usage: test_processor_tb.sh [-step]\n\
Usage: test_processor_tb.sh [-lib_map_path]\n\
Usage: test_processor_tb.sh [-reset_run]\n\
Usage: test_processor_tb.sh [-reset_log]\n\
Usage: test_processor_tb.sh [-keep_index]\n\
Usage: test_processor_tb.sh [-noclean_files]\n\n\
