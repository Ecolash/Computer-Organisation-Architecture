...
#
# Script generated by Vivado on Wed Oct 30 14:29:51 IST 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : top_module_tb.sh
...
#
# Usage        : top_module_tb.sh
#                top_module_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_module_tb.sh [-reset_run]
#                top_module_tb.sh [-reset_log]
#                top_module_tb.sh [-help]
#
...
#                script (type 'top_module_tb.sh -help' for more information).
#
...
# script info
echo -e "top_module_tb.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_module_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "/home/digantam/.var/app/com.github.corna.Vivado/data/xilinx-install/Vivado/2024.1/data/ip/xpm/xpm_memory/hdl/xpm_memory.sv" \
  2>&1 | tee compile.log; cat .tmp_log > vlogan.log 2>/dev/null

  vhdlan -work xpm $vhdlan_opts \
  "/home/digantam/.var/app/com.github.corna.Vivado/data/xilinx-install/Vivado/2024.1/data/ip/xpm/xpm_VCOMP.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log > vhdlan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k \
  "../../../../ISA\\ Project\\ -1\\ ALU\\ Design/ISA\\ Project\\ -1\\ ALU\\ Design.srcs/sim_1/new/top_module_tb.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.top_module_tb xil_defaultlib.glbl -o top_module_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./top_module_tb_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/digantam/Desktop/ISA"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key top_module_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc top_module_tb_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./top_module_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: top_module_tb.sh [-help]\n\
Usage: top_module_tb.sh [-step]\n\
Usage: top_module_tb.sh [-lib_map_path]\n\
Usage: top_module_tb.sh [-reset_run]\n\
Usage: top_module_tb.sh [-reset_log]\n\
Usage: top_module_tb.sh [-keep_index]\n\
Usage: top_module_tb.sh [-noclean_files]\n\n\
