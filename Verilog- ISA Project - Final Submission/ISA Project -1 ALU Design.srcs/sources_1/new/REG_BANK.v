// Register Bank
module reg_bank(reg_select,read_data1,read_data2,read_port1,read_port2,write_data,write_port,reset,clk,read,write,reg_data_select);
 // Input and Ouput Ports
 input [31:0]write_data;
 input clk,reset;
 input [3:0]reg_select,write_port,read_port1,read_port2;
