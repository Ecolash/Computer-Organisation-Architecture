module datapath(
    ...
    reg_bank RB(.reg_select(reg_select),.read_data1(A_in),.read_data2(B_in),.write_data(regbank_write),.read_port1(i13_10),
                    .read_port2(i17_14),.write_port(i9_6),.clk(clk),.read(1'b1),.write(WriteRP),.reg_data_select(reg_data_out),.reset(rst));
