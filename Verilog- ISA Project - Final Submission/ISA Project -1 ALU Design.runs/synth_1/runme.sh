...
HD_PWD='/home/digantam/Desktop/ISA Project -1 ALU Design/ISA Project -1 ALU Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrapper_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrapper_processor.tcl
